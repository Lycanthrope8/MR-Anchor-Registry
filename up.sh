...
echo -e "${BLUE}│${NC}  Org1 Admin:      ${GREEN}http://localhost:3000/admin-panel/org1${NC}          ${BLUE}│${NC}"
echo -e "${BLUE}│${NC}  Org2 Admin:      ${GREEN}http://localhost:3001/admin-panel/org2${NC}          ${BLUE}│${NC}"
